  ...
  return (
    ...
    >
      ...
      <div className="max-w-6xl mx-auto px-3 sm:px-6 py-2 space-y-4">
        ...
        <div className="flex items-center justify-between rounded-xl bg-[#0f172a] p-3 shadow-lg border border-yellow-600/50">
          <div className="flex flex-col flex-1 items-center justify-center border-r-2 border-yellow-600/50/20 px-1 text-center">
            <span className="text-[11px] sm:text-xs font-bold text-yellow-400 flex items-center justify-center gap-1"><span className="text-xl">📅</span> Game Starts</span>
            <span className="text-[10px] sm:text-[11px] font-bold text-yellow-400 mt-1">{formattedDate}</span>
        ...
        <div className="pt-2 border-2 border-yellow-600/50 bg-[#020617] rounded-xl p-3 shadow-inner mt-4">
          ...
          {!isLive && (
            <button
              ...
              className="w-full flex items-center justify-center gap-2 mb-3 py-2.5 rounded-lg bg-gradient-to-r from-[#0f172a] to-[#020617] border-2 border-yellow-600/50 text-yellow-500 font-bold text-xs tracking-widest uppercase hover:border-yellow-500 hover:text-yellow-300 shadow-md transition-all active:scale-[0.98]"
            >
