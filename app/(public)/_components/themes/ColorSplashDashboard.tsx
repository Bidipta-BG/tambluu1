    ...
    <div className="w-full min-h-screen bg-gradient-to-b from-pink-50 via-white to-cyan-50 font-sans text-white pb-20 overflow-x-hidden">
      ...
      <div className="max-w-6xl mx-auto px-3 sm:px-6 py-2 space-y-4">
        ...
        <div className="flex justify-center items-center gap-4 py-2">
          {/* Call Icon */}
          <a href={`tel:${tenant.whatsappNumber || ''}`} className="bg-white hover:bg-pink-50 p-3 rounded-full border border-pink-200 text-pink-500 shadow-sm transition-all inline-flex items-center justify-center">
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/></svg>
          </a>
          
          {/* WhatsApp Icon */}
          <a href={buildWhatsAppUrl(tenant.whatsappNumber || '', 'Hi, I want to inquire about the Tambola game.')} target="_blank" rel="noopener noreferrer" className="bg-white hover:bg-pink-50 p-3 rounded-full border border-pink-200 text-[#25D366] shadow-sm transition-all inline-flex items-center justify-center">
        ...
        <div className="flex items-center justify-between rounded-xl bg-white p-3 shadow-lg border-2 border-pink-300">
          <div className="flex flex-col flex-1 items-center justify-center border-r-2 border-pink-300/20 px-1 text-center">
            <span className="text-[11px] sm:text-xs font-bold text-purple-800 flex items-center justify-center gap-1"><span className="text-xl">📅</span> Game Starts</span>
            <span className="text-[10px] sm:text-[11px] font-bold text-purple-800 mt-1">{formattedDate}</span>
            <span className="text-sm font-black text-purple-800 mt-0.5">{formattedTime}</span>
          </div>
