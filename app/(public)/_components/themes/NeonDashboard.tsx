  ...
  return (
    ...
    >
      ...
      <div className="relative w-full pt-10 pb-6 px-4 flex flex-col items-center">
        ...
        {/* Title */}
        <h1 className="relative z-10 text-4xl sm:text-6xl font-serif font-black text-pink-500 drop-shadow-[0_0_8px_rgba(236,72,153,0.8)] tracking-wider text-center drop-shadow-md uppercase">
      ...
      <div className="max-w-6xl mx-auto px-3 sm:px-6 py-2 space-y-4">
        ...
        <div className="flex justify-center items-center gap-4 py-2">
          {/* Call Icon */}
          <a href={`tel:${tenant.whatsappNumber || ''}`} className="bg-[#111] hover:bg-[#222] p-3 rounded-full border border-pink-500 text-cyan-400 shadow-[0_0_8px_rgba(236,72,153,0.5)] hover:shadow-[0_0_12px_rgba(236,72,153,0.8)] transition-all inline-flex items-center justify-center">
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/></svg>
          </a>
          
          {/* WhatsApp Icon */}
          <a href={buildWhatsAppUrl(tenant.whatsappNumber || '', 'Hi, I want to inquire about the Tambola game.')} target="_blank" rel="noopener noreferrer" className="bg-[#111] hover:bg-[#222] p-3 rounded-full border border-pink-500 text-[#25D366] shadow-[0_0_8px_rgba(37,211,102,0.5)] hover:shadow-[0_0_12px_rgba(37,211,102,0.8)] transition-all inline-flex items-center justify-center">
          ...
          <div className="relative">
            <button 
              ...
              className="bg-[#1a1a2e] hover:bg-[#252542] p-3 rounded-full border border-pink-500/30 text-pink-500 drop-shadow-[0_0_5px_rgba(236,72,153,0.5)] transition-all"
              title="View Agents"
            >
          ...
          <div className="relative">
            <button 
              ...
              className="bg-[#111] hover:bg-[#222] p-3 rounded-full border border-pink-500 text-cyan-400 shadow-[0_0_8px_rgba(236,72,153,0.5)] hover:shadow-[0_0_12px_rgba(236,72,153,0.8)] transition-all"
            >
        ...
        <div className="flex items-center justify-between rounded-xl bg-black p-3 shadow-[0_0_15px_rgba(236,72,153,0.2)] border border-pink-500">
          <div className="flex flex-col flex-1 items-center justify-center border-r-2 border-purple-500/20 px-1 text-center">
            <span className="text-[11px] sm:text-xs font-bold text-cyan-400 flex items-center justify-center gap-1"><span className="text-xl">📅</span> Game Starts</span>
            <span className="text-[10px] sm:text-[11px] font-bold text-cyan-400 mt-1">{formattedDate}</span>
            <span className="text-sm font-black text-cyan-400 mt-0.5">{formattedTime}</span>
          </div>
          
          <div className="flex flex-col flex-1 items-center justify-center border-r-2 border-purple-500/20 px-1 text-center">
            <span className="text-[11px] sm:text-xs font-bold text-cyan-400 flex items-center justify-center gap-1"><span className="text-xl">⏱</span> Starts In</span>
            <CountdownTimer
              targetDate={displayGame.scheduled_at || new Date().toISOString()}
              className="text-lg font-black text-cyan-400 tracking-wide mt-1"
            />
          </div>
