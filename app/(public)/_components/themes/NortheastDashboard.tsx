        ...
        <div className="pt-2 border-2 border-[#163725] bg-[#0d2a1b] rounded-xl p-3 shadow-inner mt-4">
          ...
          {!isLive && (
            <button
              ...
              className="w-full flex items-center justify-center gap-2 mb-3 py-2.5 rounded-lg bg-gradient-to-r from-[#163725] to-[#0a2617] border-2 border-[#1e4e31] text-yellow-500 font-bold text-xs tracking-widest uppercase hover:border-yellow-500 hover:text-yellow-300 shadow-md transition-all active:scale-[0.98]"
            >
              <span className="text-sm">⚡</span>
              Quick Book
              <span className="text-[#a3b8ad] font-normal normal-case tracking-normal text-[10px]">— browse by number</span>
            </button>
          )}
